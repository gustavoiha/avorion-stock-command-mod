...
meta =
{
    ...
    description = "Always know how close you are to the core without doing the math yourself. The galaxy map gets a small label in the lower-left corner showing the euclidean straight-line distance from the selected sector to 0:0. ",
