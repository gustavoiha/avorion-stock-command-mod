...
meta =
{
    ...
    title = "Production Capacity Stats",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "In build mode on a factory or mine, shows an overlay with the station's current production capacity vs. how much it needs for the fastest cycle, plus the resulting cycle time. Non-production stations are unaffected.",
